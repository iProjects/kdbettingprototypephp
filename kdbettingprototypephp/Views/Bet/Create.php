...
<html lang="en">
    ...
    <head>
        ...
        <title>Create Bet | Maasai Integrated Development Initiatives</title>
        ...
        <div id="body">
            ...
            <section class="content-wrapper main-content clear-fix">
                ...
                <div style="float: left; clear: both;">
                    ...
                    <form id="form-createuser"  action="../../DAL/CreateBet.php" method="post" enctype="multipart/form-data">
                        <fieldset>
                            ...
                            <article class="col1">
                                <div class="pad">
                                    ...
                                    <div class="editor-label">
                                        <label for="txtusertype">Bet Type*</label> 
                                    </div>
                                    <div class="editor-field">
                                        <input id="txtusertype" name="txtusertype" placeholder="Bet Type" type="text" class="text ui-widget-content ui-corner-all" autocomplete />            
                                    </div>
        ...
        <script type="text/javascript">
            ...
            $("#btnCreate").on("click", function(e) {
                ...
                if (_usertype.length === 0) {
                    errormsg += '<li>' + " Bet Type cannot be null " + '</li>';
                    error_free = false;
                }
                if (_status.length === 0) {

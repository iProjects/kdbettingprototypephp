...
<title>Register - KDBETTING</title>
...
<form id = "register-form" method="post" enctype = "multipart/form-data" action="kdRegisterDac.php">
<fieldset>
...
<p> 
<a onclick="document.getElementById('register-form').submit()" href="#" class="button" >Register</a>
<a onclick="document.getElementById('register-form').reset()" href="#" class="button" >Reset</a>
</p>

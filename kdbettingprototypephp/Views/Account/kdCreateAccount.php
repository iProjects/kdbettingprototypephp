...
<title>Create Account - KDBETTING</title>
...
<form id = "create-account-form" method="post" enctype = "multipart/form-data" action="kdAccounts.php">
<fieldset>
...
<input name="accountname" type="text" class="text ui-widget-content ui-corner-all" id="accountname"  required="required" autocomplete="autocomplete"/>            
</div>
...
<div class="editor-field">
<input name="accountno" type="text" class="text ui-widget-content ui-corner-all" id="accountno"  required="required" autocomplete="autocomplete" />            
</div>
...
<div class="editor-field">
<input name="bookbalance" type="number" class="text ui-widget-content ui-corner-all" id="bookbalance"  required="required" min="0" />            
</div>

<div class="editor-label">
<label for="clearedbalance">Cleared Balance</label> 
</div>
<div class="editor-field">
<input name="clearedbalance" type="number" class="text ui-widget-content ui-corner-all" id="clearedbalance"  required="required"  min="0"/>            
</div>
...
<div class="editor-field">
<input name="customerid" type="number" class="text ui-widget-content ui-corner-all" id="customerid"  required="required"  min="0"/>            
</div>

<div class="editor-label">
<label for="limitflag">Limit Flag</label>    
</div>
<div class="editor-field">
<input name="limitflag" type="number" class="text ui-widget-content ui-corner-all" id="limitflag"  required="required" min="0" />            
</div>
...
<div class="editor-field">
<input name="closed" type="checkbox" class="text ui-widget-content ui-corner-all" id="closed" />       
</div>
...
<div class="editor-field">
<input name="datecreated" type="date" class="text ui-widget-content ui-corner-all" id="datecreated"  required="required" />            
</div>
...
<p> 
<a onclick="document.getElementById('create-account-form').submit()" href="#" class="button clearboth float-left" >Create</a>
<a onclick="document.getElementById('create-account-form').reset()" href="#" class="button float-left" >Reset</a>
</p>

...
<title>Create User - KDBETTING</title>
...
<div class="editor-field">
<input name="email" type="text" class="text ui-widget-content ui-corner-all" id="email" autocomplete="autocomplete"/>            
</div>
...
<div class="editor-field">
<input name="fullnames" type="text" class="text ui-widget-content ui-corner-all" id="fullnames" autocomplete="autocomplete"/>            
</div>
...
<div class="editor-field">
<input name="username" type="text" class="text ui-widget-content ui-corner-all" id="username" autocomplete="autocomplete"/>            
</div>
...
<div class="editor-field">
<input name="pwd" type="password" class="text ui-widget-content ui-corner-all" id="pwd" autocomplete="autocomplete"/>            
</div>
...
<div class="editor-field">
<input name="idno" type="text" class="text ui-widget-content ui-corner-all" id="idno" autocomplete="autocomplete"/>            
</div>
...
<div class="editor-field">
<input name="phoneno" type="tel" class="text ui-widget-content ui-corner-all" id="phoneno" autocomplete="autocomplete"/>            
</div>
...
<p> 
<a onclick="document.getElementById('create-user-form').submit()" href="#" class="button clearboth float-left" >Create</a>
<a onclick="document.getElementById('create-user-form').reset()" href="#" class="button float-left" >Reset</a>
</p>

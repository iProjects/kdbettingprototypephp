...
<title>Create Bet - KDBETTING</title>
...
<h2 class="page-title">Create Bet</h2>

<div>

<form id = "create-bet-form" method="post" enctype = "multipart/form-data" action="kdBets.php">
<fieldset>
<legend>Create Bet</legend>
...
<input name="userid" type="text" class="text ui-widget-content ui-corner-all" id="userid" autocomplete="autocomplete"/>            
</div>

<div class="editor-label">
<label for="singlebet">Single Bet</label>   
</div> 
<div class="editor-field">
<input name="singlebet" type="text" class="text ui-widget-content ui-corner-all" id="singlebet" autocomplete="autocomplete"/>            
</div>

<div class="editor-label">
<label for="multiplebets">Multiple Bets</label>  
</div>
<div class="editor-field">
<input name="multiplebets" type="text" class="text ui-widget-content ui-corner-all" id="multiplebets" autocomplete="autocomplete"/>            
</div>

<div class="editor-label">
<label for="betvalidity">Bet Validity</label> 
</div>
<div class="editor-field">
<input name="betvalidity" type="text" class="text ui-widget-content ui-corner-all" id="betvalidity" autocomplete="autocomplete"/>            
</div>
...
<div class="editor-label">
<label for="betclosed">Bet Closed</label>    
</div>
<div class="editor-field">
<input name="betclosed" type="checkbox" class="text ui-widget-content ui-corner-all" id="betclosed"/>            
</div>
...
<div class="editor-field">
<input name="status" type="text" class="text ui-widget-content ui-corner-all" id="status" autocomplete="autocomplete"/>            
</div>
...
<div class="editor-field">
<input name="datecreated" type="date" class="text ui-widget-content ui-corner-all" id="datecreated"/>            
</div>

<label for="expirydate">Expiry Date</label>    
</div>
<div class="editor-field">
<input name="expirydate" type="date" class="text ui-widget-content ui-corner-all" id="expirydate"/>            
</div>
...
<p> 
<a onclick="document.getElementById('create-bet-form').submit()" href="#" class="button clearboth float-left" >Create</a>
<a onclick="document.getElementById('create-bet-form').reset()" href="#" class="button float-left" >Reset</a>
</p>

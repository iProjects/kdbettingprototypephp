...
<title>Edit Game - KDBETTING</title>
...
<form id = "create-account-form" method="post" enctype = "multipart/form-data" action="kdGames.php">
<fieldset>
<legend>Create Game</legend>

<div class="editor-label">
<label for="accountname">Game Name</label>  
</div>
<div class="editor-field">
<input name="accountname" type="text" class="text ui-widget-content ui-corner-all" id="accountname"/>            
</div>

<div class="editor-label">
<label for="accountno">Game No</label>   
</div> 
<div class="editor-field">
<input name="accountno" type="text" class="text ui-widget-content ui-corner-all" id="accountno"/>            
</div>
...
<div class="editor-field">
<input name="bookbalance" type="text" class="text ui-widget-content ui-corner-all" id="bookbalance"/>            
</div>
...
<div class="editor-field">
<input name="clearedbalance" type="text" class="text ui-widget-content ui-corner-all" id="clearedbalance"/>            
</div>
...
<div class="editor-field">
<input name="customerid" type="text" class="text ui-widget-content ui-corner-all" id="customerid"/>            
</div>
...
<div class="editor-field">
<input name="limitflag" type="text" class="text ui-widget-content ui-corner-all" id="limitflag"/>            
</div>
...
<div class="editor-field">
<input name="closed" type="text" class="text ui-widget-content ui-corner-all" id="closed"/>            
</div>
...
<p> 
<a onclick="document.getElementById('create-account-form').submit()" href="#" class="button" >Create</a>
<a onclick="document.getElementById('create-account-form').reset()" href="#" class="button" >Reset</a>
</p>

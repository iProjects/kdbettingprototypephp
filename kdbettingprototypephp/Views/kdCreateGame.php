...
<title>Create Game - KDBETTING</title>
...
<form id = "create-game-form" method="post" enctype = "multipart/form-data" action="kdGames.php">
<fieldset>
...
<label for="gameno">Game No</label>   
</div> 
<div class="editor-field">
<input name="gameno" type="text" class="text ui-widget-content ui-corner-all" id="gameno" autocomplete="autocomplete"/>            
</div>
...
<div class="editor-field">
<input name="gamedescription" type="text" class="text ui-widget-content ui-corner-all" id="gamedescription" autocomplete="autocomplete"/>            
</div>
...
<div class="editor-field">
<input name="gamedate" type="date" class="text ui-widget-content ui-corner-all" id="gamedate"/>            
</div>
...
<div class="editor-field">
<input name="gametime" type="time" class="text ui-widget-content ui-corner-all" id="gametime"/>            
</div>
...
<div class="editor-field">
<input name="hometeam" type="text" class="text ui-widget-content ui-corner-all" id="hometeam" autocomplete="autocomplete"/>            
</div>
...
<div class="editor-field">
<input name="visitingteam" type="text" class="text ui-widget-content ui-corner-all" id="visitingteam" autocomplete="autocomplete"/>            
</div>
...
<div class="editor-field">
<label for="winningteambetodd">Winning Team Bet Odd</label>    
</div>
<div class="editor-field">
<input name="winningteambetodd" type="text" class="text ui-widget-content ui-corner-all" id="winningteambetodd" autocomplete="autocomplete"/>            
</div>

<div class="editor-field">
<label for="losingteambetodd">Losing Team Bet Odd</label>    
</div>
<div class="editor-field">
<input name="losingteambetodd" type="text" class="text ui-widget-content ui-corner-all" id="losingteambetodd" autocomplete="autocomplete"/>            
</div>
...
<div class="editor-field">
<input name="gamecategory" type="text" class="text ui-widget-content ui-corner-all" id="gamecategory" autocomplete="autocomplete"/>            
</div>

<div class="editor-field">
<label for="gamevenue">Game Venue</label>    
</div>
<div class="editor-field">
<input name="gamevenue" type="text" class="text ui-widget-content ui-corner-all" id="gamevenue" autocomplete="autocomplete"/>            
</div>
...
<p> 
<a onclick="document.getElementById('create-game-form').submit()" href="#" class="button clearboth float-left" >Create</a>
<a onclick="document.getElementById('create-game-form').reset()" href="#" class="button float-left" >Reset</a>
</p>

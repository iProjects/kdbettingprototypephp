...
<title>Edit Bet - KDBETTING</title>
...
<input name="userid" type="text" class="text ui-widget-content ui-corner-all" id="userid"/>            
</div>
...
<div class="editor-field">
<input name="singlebet" type="text" class="text ui-widget-content ui-corner-all" id="singlebet"/>            
</div>
...
<div class="editor-field">
<input name="multiplebets" type="text" class="text ui-widget-content ui-corner-all" id="multiplebets"/>            
</div>
...
<div class="editor-field">
<input name="betvalidity" type="text" class="text ui-widget-content ui-corner-all" id="betvalidity"/>            
</div>
...
<div class="editor-field">
<input name="betclosed" type="text" class="text ui-widget-content ui-corner-all" id="betclosed"/>            
</div>
...
<div class="editor-field">
<input name="expirydate" type="text" class="text ui-widget-content ui-corner-all" id="expirydate"/>            
</div>

<p> 
<a onclick="document.getElementById('create-bet-form').submit()" href="#" class="button" >Create</a>
<a onclick="document.getElementById('create-bet-form').reset()" href="#" class="button" >Reset</a>
</p>

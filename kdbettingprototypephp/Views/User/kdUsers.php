...
// Insert data
$sql_insert = "INSERT INTO kdUsers(Email, FullNames, UserName, PassWord, IdNo, PhoneNo, Status, DateCreated) VALUES (?,?,?,?,?,?,?,getDate())";
...
<p>
<a id="btnSubmitCreateUserForm" style="cursor: pointer;" title="Create User" href="kdCreateUser.php">Create User</a>
...
//read data
$sql_select = "SELECT * FROM kdUsers ORDER BY Id ASC";
...
echo "<td>".$game['Email']."</td>";
echo "<td>".$game['FullNames']."</td>";
echo "<td>".$game['UserName']."</td>";
echo "<td>".$game['PassWord']."</td>";
echo "<td>".$game['IdNo']."</td>";
echo "<td>".$game['PhoneNo']."</td>";
